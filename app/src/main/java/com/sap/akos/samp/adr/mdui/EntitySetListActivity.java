package com.sap.akos.samp.adr.mdui;
...
import com.sap.akos.samp.adr.mdui.customers.CustomersFioriMapActivity;
import com.sap.cloud.mobile.foundation.mobileservices.SDKInitializer;
import com.sap.cloud.mobile.foundation.usage.UsageService;
import com.sap.akos.samp.adr.mdui.customers.CustomersActivity;
import com.sap.akos.samp.adr.mdui.productcategories.ProductCategoriesActivity;
import com.sap.akos.samp.adr.mdui.producttexts.ProductTextsActivity;
import com.sap.akos.samp.adr.mdui.products.ProductsActivity;
import com.sap.akos.samp.adr.mdui.purchaseorderheaders.PurchaseOrderHeadersActivity;
...
import com.sap.akos.samp.adr.mdui.salesorderitems.SalesOrderItemsActivity;
import com.sap.akos.samp.adr.mdui.stock.StockActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            switch (entitySetName) {
                case Customers:
                    intent = new Intent(context, CustomersFioriMapActivity.class);
                    break;
